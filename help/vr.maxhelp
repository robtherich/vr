...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 720.0, 68.0, 165.0, 48.0 ],
					"presentation_rect" : [ 474.0, 88.0, 0.0, 0.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 260.25, 300.0, 123.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 24.0, 409.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 172.0, 141.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 24.0, 133.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "t b b"
				}
...
,
					"patching_rect" : [ 42.583328, 202.375, 63.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 24.0, 19.0, 136.0, 22.0 ],
									"style" : "",
...
,
					"patching_rect" : [ 260.25, 327.0, 90.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 339.0, 270.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "print vr-info"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 181.500015, 286.0, 77.0, 36.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 102.750008, 286.0, 77.0, 36.0 ],
					"style" : "",
					"text" : "jit.gl.camera world"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 24.0, 450.0, 276.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 24.0, 382.0, 393.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.node @name world @erase_color 0 0 0 1 @capture 1 @antialias 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 169.0, 133.0, 80.0, 36.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "" ],
					"patching_rect" : [ 24.0, 94.0, 308.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 24.0, 242.0, 334.000031, 22.0 ],
					"style" : "",
					"text" : "vr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.583328, 352.0, 150.0, 22.0 ],
					"style" : "",
					"text_width" : 50.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 116.0, 202.375, 124.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 248.999985, 202.375, 129.0, 22.0 ],
					"style" : "",
					"text_width" : 75.0
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 50.0, 130.0, 649.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 50.0, 100.0, 718.0, 22.0 ],
									"style" : "",
...
,
					"patching_rect" : [ 795.0, 120.0, 44.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 720.0, 120.0, 58.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "jit.gl.mesh world @draw_mode points @blend_enable 1 @blend alphaadd @depth_write 0 @color 1 1 1 1 @point_size 4"
								}
...
,
					"patching_rect" : [ 720.0, 159.0, 65.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 86.0, 420.0, 394.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 44.0, 438.0, 422.166656, 438.0, 422.166656, 235.0, 33.5, 235.0 ],
					"source" : [ "obj-14", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 125.5, 231.0, 36.0, 231.0, 36.0, 237.0, 33.5, 237.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 258.5, 232.0, 36.0, 232.0, 36.0, 237.0, 33.5, 237.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-28", 0 ],
					"midpoints" : [ 178.0, 124.0, 33.5, 124.0 ],
					"order" : 1,
					"source" : [ "obj-2", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 178.0, 123.0, 178.5, 123.0 ],
					"order" : 0,
					"source" : [ "obj-2", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 52.083328, 229.0, 36.0, 229.0, 36.0, 237.0, 33.5, 237.0 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 33.5, 161.0, 33.5, 161.0 ],
					"source" : [ "obj-28", 0 ]
				}
